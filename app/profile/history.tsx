...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, ActivityIndicator, Image, RefreshControl, Alert, Modal } from 'react-native';
import { useRouter } from 'expo-router';
import { ArrowLeft, Calendar, MapPin, Clock, ChevronRight, Trophy, Shield, Users, CreditCard, CheckCircle, XCircle, AlertCircle } from 'lucide-react-native';
        ...
        <View style={styles.container}>
            ...
            <Modal visible={modalVisible} transparent animationType="slide">
                <View style={styles.modalOverlay}>
                    <Animated.View entering={FadeInUp.springify()} style={styles.ticketContainer}>
                        {/* TICKET TOP */}
                        <View style={styles.ticketHeader}>
                            <View>
                                <Text style={styles.ticketBrand}>ARENAPRO PASS</Text>
                                <Text style={styles.ticketId}>ID: {selectedBooking?._id?.toUpperCase()}</Text>
                            </View>
...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 60, paddingHorizontal: 20, paddingBottom: 20, backgroundColor: '#0F172A' },
